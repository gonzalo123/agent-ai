...
@click.command()
def run() -> None:
    """Execute the math expert agent with a predefined question.

    This command demonstrates the math agent capabilities by asking
    for the square root of 16, divided by 2, then squared.
    """
    question = (
