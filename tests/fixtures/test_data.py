...
SAMPLE_BEDROCK_RESPONSE = {
    "ResponseMetadata": {
        ...
        "HTTPStatusCode": 200,
        "HTTPHeaders": {"content-type": "application/json", "content-length": "123"},
    },
...
SAMPLE_AGENT_RESPONSES = {
    ...
    "history_request": {
        ...
        "intermediate_steps": [("get_history", {"result": "12 + 8 = 20\n20 - 5 = 15"})],
    },
}
...
PERFORMANCE_BENCHMARKS = {
    "tool_execution": {"max_time_seconds": 0.1, "operations_per_second": 1000},
    "llm_initialization": {"max_time_seconds": 5.0, "memory_usage_mb": 100},
    "history_retrieval": {"max_time_seconds": 0.01, "max_operations": 10000},
}
...
def create_mock_bedrock_response(content: str, model: str = "claude-3-sonnet") -> dict:
    ...
    return {
        ...
        "contentType": "application/json",
        "body": json.dumps(
            {"completion": content, "stop_reason": "end_turn", "model": model}
        ).encode(),
    }


def create_mock_agent_response(
    input_text: str, output_text: str, steps: list = None
) -> dict:
    """
