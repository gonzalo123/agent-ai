...
class TestMathExpertCommand:
    ...
    def test_aws_configuration_parameters(self):
        ...
        from commands.math_expert import (
            AWS_ASSUME_ROLE, AWS_REGION, AWS_PROFILE_NAME, 
            AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
        )
        from settings import (
            AWS_ASSUME_ROLE as SETTINGS_ASSUME_ROLE,
            AWS_REGION as SETTINGS_REGION,
            AWS_PROFILE_NAME as SETTINGS_PROFILE_NAME,
            AWS_ACCESS_KEY_ID as SETTINGS_ACCESS_KEY_ID,
            AWS_SECRET_ACCESS_KEY as SETTINGS_SECRET_ACCESS_KEY
        )
    ...
    def test_command_execution_parameters(self, mock_run_process):
        ...
        expected_question = ("What's the square root of 16 divided by two, squared? "
                           "Show me also the history of operations.")
        mock_run_process.assert_called_once_with(expected_question, model=Models.CLAUDE_4)
