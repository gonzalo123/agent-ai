...
class TestLLMModule:
    ...
    def test_run_function_basic_execution(self, mock_math_tools, mock_agent_executor, 
                                         mock_create_agent, mock_get_llm):
    ...
    @patch('modules.llm.AgentExecutor')
    @patch('modules.llm.MathTools')
    def test_run_function_uses_correct_model(self, mock_math_tools, mock_agent_executor,
                                           mock_create_agent, mock_get_llm):
        ...
        mock_get_llm.assert_called_once_with(model=Models.CLAUDE_4, max_tokens=MAX_TOKENS)
    
    @patch('modules.llm.get_llm')
    @patch('modules.llm.create_tool_calling_agent')
    @patch('modules.llm.AgentExecutor')
    @patch('modules.llm.MathTools')
    def test_run_function_agent_executor_configuration(self, mock_math_tools, mock_agent_executor,
                                                      mock_create_agent, mock_get_llm):
    ...
    @patch('modules.llm.AgentExecutor')
    @patch('modules.llm.MathTools')
    def test_run_function_prompt_template(self, mock_math_tools, mock_agent_executor,
                                         mock_create_agent, mock_get_llm):
    ...
    @patch('modules.llm.AgentExecutor')
    @patch('modules.llm.MathTools')
    def test_run_function_handles_complex_question(self, mock_math_tools, mock_agent_executor,
                                                  mock_create_agent, mock_get_llm):
    ...
    @patch('modules.llm.AgentExecutor')
    @patch('modules.llm.MathTools')
    def test_run_function_uses_system_prompt(self, mock_math_tools, mock_agent_executor,
                                           mock_create_agent, mock_get_llm):
    ...
    def test_run_function_handles_tools_error(self, mock_math_tools, mock_agent_executor,
                                             mock_create_agent, mock_get_llm):
